...
async def _one_shot(agent: EmailTriageAgent, query: str, trace: bool = False) -> int:
    """Run a single query and print the result."""
    try:
        result = await agent.process_query(query, trace=trace)
...
async def _interactive(agent: EmailTriageAgent, trace: bool = False) -> int:
