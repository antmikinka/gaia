...
|-------|----------|----------|--------|
| **GaiaAgent** (née `ChatAgent`, renamed in v0.20.0) | Documents | Document Q&A with RAG | [`agents/chat/`](/guides/chat) |
...
| **SDAgent** | Creative | Image generation with SD + VLM | [`agents/sd/`](/guides/sd) |
| **Talk SDK** (voice I/O for agents) | Voice | Speech-to-speech wrapper around any agent | [`gaia/talk/`](/guides/talk) |
