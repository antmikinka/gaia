...
- **GAIA CLI**: Run `gaia init --profile <profile>` to download models for a specific use case (minimal, chat, code, rag, all)
...
To remove all downloaded models: `gaia uninstall --models`
