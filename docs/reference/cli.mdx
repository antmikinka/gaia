...
| `talk` | Qwen3.5-35B | Voice-enabled chat | ~18 GB |
| `rag` | Qwen3.5-35B, nomic-embed, Qwen3-VL-4B | Document Q&A with retrieval and vision | ~25 GB |
| `blender` | Qwen3.5-35B | 3D content generation in Blender | ~18 GB |
| `jira` | Qwen3.5-35B | Jira issue management | ~18 GB |
| `docker` | Qwen3.5-35B | Docker container management | ~18 GB |
...
| `--model` | string | Qwen3.5-35B-A3B-GGUF | Model name to use |
