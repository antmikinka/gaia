...
<Tip>
  **New in v0.17:** The Agent UI now includes a **Pipeline Runner** page for executing the 5-stage autonomous agent pipeline with real-time SSE streaming. Access it via the "Run Pipeline" button (⚡) in the sidebar. See the [Agent UI Guide](/guides/agent-ui#pipeline-runner) for details.
</Tip>
