...
<div style={{textAlign: 'center', padding: '48px 0 24px 0'}}>
  <h1 style={{fontSize: '3.2rem', fontWeight: 900, marginBottom: '24px', lineHeight: 1.1}}>
    Build AI Agents That Run <span style={{color: '#ED1C24'}}>Locally</span>
  </h1>
...
<CardGroup cols={4}>
  ...
  <Card title="No Cloud Dependency" icon="server">
...
<CardGroup cols={3}>
  <Card title="Agent UI" icon="desktop" href="/quickstart#agent-ui-fastest">
