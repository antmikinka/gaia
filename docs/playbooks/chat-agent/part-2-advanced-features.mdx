...
# Replace with the session ID you want to load
agent.load_session("session_20241211_143000")
# All indexed documents and conversation history are restored!
agent.process_query("What are the current indexed files")
...
<Tabs>
  <Tab title="Full Configuration">
    ...
    # Documents to index on startup
        ...
        model_id="Qwen3.5-35B-A3B-GGUF",  # Runs on Ryzen AI
        max_steps=10,
