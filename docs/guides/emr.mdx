...
<Tabs>
  <Tab title="CLI App">
    ...
    [Download sample intake forms from GitHub](https://github.com/amd/gaia/tree/main/src/gaia/agents/emr) and save them to a local directory (e.g., `./intake-forms/`).

    <Note>
      **Dev Install:** See the EMR agent source at `src/gaia/agents/emr/` for sample forms and configuration.
    </Note>
  ...
  <Tab title="Desktop App">
    ...
    <Tip>
      [Download sample intake forms from GitHub](https://github.com/amd/gaia/tree/main/src/gaia/agents/emr) to test the agent.
    </Tip>
