...
Usage:
    ...
    template = RecursivePipelineTemplate(
        ...
        agent_categories={
            ...
            "MANAGEMENT": ["software-program-manager"],
        },
    ...
    def _create_default_phases(self) -> List[PhaseConfig]:
        ...
        return [
            ...
            PhaseConfig(
                ...
                selection_mode=SelectionMode.AUTO,
                agents=self.agent_categories.get("review", []),
            ...
            PhaseConfig(
                ...
                selection_mode=SelectionMode.AUTO,
                agents=self.agent_categories.get("management", []),
                exit_criteria={"artifact": "final_approval"},
            ),
        ]
...
ENTERPRISE_TEMPLATE = RecursivePipelineTemplate(
    ...
    agent_categories={
        ...
        "development": ["senior-developer"],
        "review": ["quality-reviewer", "security-auditor", "performance-analyst"],
        "management": ["software-program-manager"],
    },
    routing_rules=[
        RoutingRule(
