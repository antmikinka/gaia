...
# ====================== CONFIG ======================
JSONL_PATH = Path(__file__).resolve().parents[1] / "stratified_1000.jsonl"
...
def main():
    global JSONL_PATH
    parser = argparse.ArgumentParser(description="Smart interactive email bencher")
    parser.add_argument("--jsonl-path", type=Path, default=None,
                        help="Path to stratified JSONL file (default: ../stratified_1000.jsonl)")
